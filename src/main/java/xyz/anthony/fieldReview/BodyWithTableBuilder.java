...
public class BodyWithTableBuilder {
    public static Document createIt() {
        ...
        rpr31.setRFonts(rfonts56);
        rfonts56.setAscii("Arial");
        rfonts56.setHAnsi("Arial");
        rfonts56.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue63 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr31.setBCs(booleandefaulttrue63);
        // Create object for color
        Color color56 = wmlObjectFactory.createColor();
        rpr31.setColor(color56);
        ...
        rfonts57.setAscii("Arial");
        rfonts57.setHAnsi("Arial");
        rfonts57.setCs("Arial");
        // Create object for b
        BooleanDefaultTrue booleandefaulttrue64 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr27.setB(booleandefaulttrue64);
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue65 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr27.setBCs(booleandefaulttrue65);
        // Create object for color
        Color color57 = wmlObjectFactory.createColor();
        pararpr27.setColor(color57);
        color57.setVal("365F91");
        color57.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color57.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle7 = wmlObjectFactory.createPPrBasePStyle();
        ppr27.setPStyle(pprbasepstyle7);
        pprbasepstyle7.setVal("ListParagraph");
        ...
        rfonts58.setAscii("Arial");
        rfonts58.setHAnsi("Arial");
        rfonts58.setCs("Arial");
        // Create object for b
        BooleanDefaultTrue booleandefaulttrue66 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr28.setB(booleandefaulttrue66);
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue67 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr28.setBCs(booleandefaulttrue67);
        // Create object for color
        Color color58 = wmlObjectFactory.createColor();
        pararpr28.setColor(color58);
        color58.setVal("365F91");
        color58.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color58.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle8 = wmlObjectFactory.createPPrBasePStyle();
        ppr28.setPStyle(pprbasepstyle8);
        pprbasepstyle8.setVal("ListParagraph");
        // Create object for p
        P p29 = wmlObjectFactory.createP();
        tc4.getContent().add(p29);
        // Create object for r
        R r32 = wmlObjectFactory.createR();
        p29.getContent().add(r32);
        // Create object for t (wrapped in JAXBElement)
        ...
        text32.setValue("South-East windows installed at the grade level.");
        // Create object for rPr
        RPr rpr32 = wmlObjectFactory.createRPr();
        r32.setRPr(rpr32);
        // Create object for rFonts
        RFonts rfonts59 = wmlObjectFactory.createRFonts();
        rpr32.setRFonts(rfonts59);
        rfonts59.setAscii("Arial");
        rfonts59.setHAnsi("Arial");
        rfonts59.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue68 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr32.setBCs(booleandefaulttrue68);
        // Create object for color
        Color color59 = wmlObjectFactory.createColor();
        rpr32.setColor(color59);
        color59.setVal("365F91");
        color59.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color59.setThemeShade("BF");
        // Create object for pPr
        ...
        rfonts60.setAscii("Arial");
        rfonts60.setHAnsi("Arial");
        rfonts60.setCs("Arial");
        // Create object for b
        BooleanDefaultTrue booleandefaulttrue69 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr29.setB(booleandefaulttrue69);
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue70 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr29.setBCs(booleandefaulttrue70);
        // Create object for color
        Color color60 = wmlObjectFactory.createColor();
        pararpr29.setColor(color60);
        color60.setVal("365F91");
        color60.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color60.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle9 = wmlObjectFactory.createPPrBasePStyle();
        ppr29.setPStyle(pprbasepstyle9);
        pprbasepstyle9.setVal("ListParagraph");
        // Create object for numPr
        PPrBase.NumPr pprbasenumpr2 = wmlObjectFactory.createPPrBaseNumPr();
        ppr29.setNumPr(pprbasenumpr2);
        // Create object for ilvl
        ...
        pprbasenumprnumid2.setVal(BigInteger.valueOf(43));
        // Create object for p
        P p30 = wmlObjectFactory.createP();
        tc4.getContent().add(p30);
        // Create object for pPr
        ...
        rfonts61.setAscii("Arial");
        rfonts61.setHAnsi("Arial");
        rfonts61.setCs("Arial");
        // Create object for b
        BooleanDefaultTrue booleandefaulttrue71 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr30.setB(booleandefaulttrue71);
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue72 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr30.setBCs(booleandefaulttrue72);
        // Create object for color
        Color color61 = wmlObjectFactory.createColor();
        pararpr30.setColor(color61);
        color61.setVal("365F91");
        color61.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color61.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle10 = wmlObjectFactory.createPPrBasePStyle();
        ppr30.setPStyle(pprbasepstyle10);
        pprbasepstyle10.setVal("ListParagraph");
        // Create object for p
        P p31 = wmlObjectFactory.createP();
        tc4.getContent().add(p31);
        // Create object for r
        R r33 = wmlObjectFactory.createR();
        p31.getContent().add(r33);
        // Create object for t (wrapped in JAXBElement)
        ...
        text33.setValue(
                "Window framing installed on the South, East and West walls and in progress on Levels 2,3 and 4.");
        // Create object for rPr
        RPr rpr33 = wmlObjectFactory.createRPr();
        r33.setRPr(rpr33);
        // Create object for rFonts
        RFonts rfonts62 = wmlObjectFactory.createRFonts();
        rpr33.setRFonts(rfonts62);
        rfonts62.setAscii("Arial");
        rfonts62.setHAnsi("Arial");
        rfonts62.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue73 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr33.setBCs(booleandefaulttrue73);
        // Create object for color
        Color color62 = wmlObjectFactory.createColor();
        rpr33.setColor(color62);
        color62.setVal("365F91");
        color62.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color62.setThemeShade("BF");
        // Create object for pPr
        ...
        rfonts63.setAscii("Arial");
        rfonts63.setHAnsi("Arial");
        rfonts63.setCs("Arial");
        // Create object for b
        BooleanDefaultTrue booleandefaulttrue74 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr31.setB(booleandefaulttrue74);
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue75 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr31.setBCs(booleandefaulttrue75);
        // Create object for color
        Color color63 = wmlObjectFactory.createColor();
        pararpr31.setColor(color63);
        color63.setVal("365F91");
        color63.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color63.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle11 = wmlObjectFactory.createPPrBasePStyle();
        ppr31.setPStyle(pprbasepstyle11);
        pprbasepstyle11.setVal("ListParagraph");
        // Create object for numPr
        ...
        pprbasenumprnumid3.setVal(BigInteger.valueOf(43));
        // Create object for p
        P p32 = wmlObjectFactory.createP();
        tc4.getContent().add(p32);
        // Create object for pPr
        ...
        rfonts64.setAscii("Arial");
        rfonts64.setHAnsi("Arial");
        rfonts64.setCs("Arial");
        // Create object for b
        BooleanDefaultTrue booleandefaulttrue76 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr32.setB(booleandefaulttrue76);
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue77 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr32.setBCs(booleandefaulttrue77);
        // Create object for color
        Color color64 = wmlObjectFactory.createColor();
        pararpr32.setColor(color64);
        color64.setVal("365F91");
        color64.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color64.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle12 = wmlObjectFactory.createPPrBasePStyle();
        ppr32.setPStyle(pprbasepstyle12);
        pprbasepstyle12.setVal("ListParagraph");
        // Create object for p
        P p33 = wmlObjectFactory.createP();
        tc4.getContent().add(p33);
        // Create object for r
        R r34 = wmlObjectFactory.createR();
        p33.getContent().add(r34);
        // Create object for t (wrapped in JAXBElement)
        ...
        rpr34.setRFonts(rfonts65);
        rfonts65.setAscii("Arial");
        rfonts65.setHAnsi("Arial");
        rfonts65.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue78 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr34.setBCs(booleandefaulttrue78);
        // Create object for color
        Color color65 = wmlObjectFactory.createColor();
        rpr34.setColor(color65);
        color65.setVal("365F91");
        color65.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color65.setThemeShade("BF");
        // Create object for r
        R r35 = wmlObjectFactory.createR();
        p33.getContent().add(r35);
        // Create object for t (wrapped in JAXBElement)
        ...
        rpr35.setRFonts(rfonts66);
        rfonts66.setAscii("Arial");
        rfonts66.setHAnsi("Arial");
        rfonts66.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue79 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr35.setBCs(booleandefaulttrue79);
        // Create object for color
        Color color66 = wmlObjectFactory.createColor();
        rpr35.setColor(color66);
        color66.setVal("365F91");
        color66.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color66.setThemeShade("BF");
        // Create object for r
        ...
        text36.setValue("Windows & sliding doors installed at the time of our visits.");
        // Create object for rPr
        RPr rpr36 = wmlObjectFactory.createRPr();
        r36.setRPr(rpr36);
        // Create object for rFonts
        RFonts rfonts67 = wmlObjectFactory.createRFonts();
        rpr36.setRFonts(rfonts67);
        rfonts67.setAscii("Arial");
        rfonts67.setHAnsi("Arial");
        rfonts67.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue80 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr36.setBCs(booleandefaulttrue80);
        // Create object for color
        Color color67 = wmlObjectFactory.createColor();
        rpr36.setColor(color67);
        color67.setVal("365F91");
        color67.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color67.setThemeShade("BF");
        // Create object for pPr
        ...
        rfonts68.setAscii("Arial");
        rfonts68.setHAnsi("Arial");
        rfonts68.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue81 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr33.setBCs(booleandefaulttrue81);
        // Create object for color
        Color color68 = wmlObjectFactory.createColor();
        pararpr33.setColor(color68);
        color68.setVal("365F91");
        color68.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color68.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle13 = wmlObjectFactory.createPPrBasePStyle();
        ppr33.setPStyle(pprbasepstyle13);
        pprbasepstyle13.setVal("ListParagraph");
        // Create object for numPr
        PPrBase.NumPr pprbasenumpr4 = wmlObjectFactory.createPPrBaseNumPr();
        ppr33.setNumPr(pprbasenumpr4);
        // Create object for ilvl
        ...
        pprbasenumprnumid4.setVal(BigInteger.valueOf(43));
        // Create object for p
        P p34 = wmlObjectFactory.createP();
        tc4.getContent().add(p34);
        // Create object for pPr
        ...
        rfonts69.setAscii("Arial");
        rfonts69.setHAnsi("Arial");
        rfonts69.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue82 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr34.setBCs(booleandefaulttrue82);
        // Create object for color
        Color color69 = wmlObjectFactory.createColor();
        pararpr34.setColor(color69);
        color69.setVal("365F91");
        color69.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color69.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle14 = wmlObjectFactory.createPPrBasePStyle();
        ppr34.setPStyle(pprbasepstyle14);
        pprbasepstyle14.setVal("ListParagraph");
        // Create object for p
        P p35 = wmlObjectFactory.createP();
        tc4.getContent().add(p35);
        // Create object for r
        R r37 = wmlObjectFactory.createR();
        p35.getContent().add(r37);
        // Create object for t (wrapped in JAXBElement)
        ...
        text37.setValue("L3 & L4 sliding doors was in progress; South, East and West.");
        // Create object for rPr
        RPr rpr37 = wmlObjectFactory.createRPr();
        r37.setRPr(rpr37);
        // Create object for rFonts
        RFonts rfonts70 = wmlObjectFactory.createRFonts();
        rpr37.setRFonts(rfonts70);
        rfonts70.setAscii("Arial");
        rfonts70.setHAnsi("Arial");
        rfonts70.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue83 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr37.setBCs(booleandefaulttrue83);
        // Create object for color
        Color color70 = wmlObjectFactory.createColor();
        rpr37.setColor(color70);
        color70.setVal("365F91");
        color70.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color70.setThemeShade("BF");
        // Create object for pPr
        ...
        rfonts71.setAscii("Arial");
        rfonts71.setHAnsi("Arial");
        rfonts71.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue84 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr35.setBCs(booleandefaulttrue84);
        // Create object for color
        Color color71 = wmlObjectFactory.createColor();
        pararpr35.setColor(color71);
        color71.setVal("365F91");
        color71.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color71.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle15 = wmlObjectFactory.createPPrBasePStyle();
        ppr35.setPStyle(pprbasepstyle15);
        pprbasepstyle15.setVal("ListParagraph");
        // Create object for numPr
        PPrBase.NumPr pprbasenumpr5 = wmlObjectFactory.createPPrBaseNumPr();
        ppr35.setNumPr(pprbasenumpr5);
        // Create object for ilvl
        ...
        pprbasenumprnumid5.setVal(BigInteger.valueOf(43));
        // Create object for p
        P p36 = wmlObjectFactory.createP();
        tc4.getContent().add(p36);
        // Create object for pPr
        ...
        pararpr36.setRFonts(rfonts72);
        rfonts72.setAscii("Arial");
        rfonts72.setHAnsi("Arial");
        rfonts72.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue85 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr36.setBCs(booleandefaulttrue85);
        // Create object for color
        Color color72 = wmlObjectFactory.createColor();
        pararpr36.setColor(color72);
        color72.setVal("365F91");
        color72.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color72.setThemeShade("BF");
        // Create object for pStyle
        ...
        tc4.getContent().add(p37);
        // Create object for r
        R r38 = wmlObjectFactory.createR();
        p37.getContent().add(r38);
        // Create object for t (wrapped in JAXBElement)
        ...
        text38.setValue("L5 to L7 sliding doors & windows is well underway.");
        // Create object for rPr
        RPr rpr38 = wmlObjectFactory.createRPr();
        r38.setRPr(rpr38);
        // Create object for rFonts
        RFonts rfonts73 = wmlObjectFactory.createRFonts();
        rpr38.setRFonts(rfonts73);
        rfonts73.setAscii("Arial");
        rfonts73.setHAnsi("Arial");
        rfonts73.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue86 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr38.setBCs(booleandefaulttrue86);
        // Create object for color
        Color color73 = wmlObjectFactory.createColor();
        rpr38.setColor(color73);
        color73.setVal("365F91");
        color73.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color73.setThemeShade("BF");
        // Create object for pPr
        ...
        rfonts74.setAscii("Arial");
        rfonts74.setHAnsi("Arial");
        rfonts74.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue87 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr37.setBCs(booleandefaulttrue87);
        // Create object for color
        Color color74 = wmlObjectFactory.createColor();
        pararpr37.setColor(color74);
        color74.setVal("365F91");
        color74.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color74.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle17 = wmlObjectFactory.createPPrBasePStyle();
        ppr37.setPStyle(pprbasepstyle17);
        pprbasepstyle17.setVal("ListParagraph");
        // Create object for numPr
        PPrBase.NumPr pprbasenumpr6 = wmlObjectFactory.createPPrBaseNumPr();
        ppr37.setNumPr(pprbasenumpr6);
        // Create object for ilvl
        ...
        pprbasenumprnumid6.setVal(BigInteger.valueOf(43));
        // Create object for p
        P p38 = wmlObjectFactory.createP();
        tc4.getContent().add(p38);
        // Create object for pPr
        ...
        rfonts75.setAscii("Arial");
        rfonts75.setHAnsi("Arial");
        rfonts75.setCs("Arial");
        // Create object for b
        BooleanDefaultTrue booleandefaulttrue88 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr38.setB(booleandefaulttrue88);
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue89 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr38.setBCs(booleandefaulttrue89);
        // Create object for color
        Color color75 = wmlObjectFactory.createColor();
        pararpr38.setColor(color75);
        color75.setVal("365F91");
        color75.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color75.setThemeShade("BF");
        // Create object for p
        P p39 = wmlObjectFactory.createP();
        tc4.getContent().add(p39);
        // Create object for r
        R r39 = wmlObjectFactory.createR();
        p39.getContent().add(r39);
        // Create object for t (wrapped in JAXBElement)
        ...
        text39.setValue("L9 Level s");
        // Create object for rPr
        RPr rpr39 = wmlObjectFactory.createRPr();
        r39.setRPr(rpr39);
        // Create object for rFonts
        RFonts rfonts76 = wmlObjectFactory.createRFonts();
        rpr39.setRFonts(rfonts76);
        rfonts76.setAscii("Arial");
        rfonts76.setHAnsi("Arial");
        rfonts76.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue90 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr39.setBCs(booleandefaulttrue90);
        // Create object for color
        Color color76 = wmlObjectFactory.createColor();
        rpr39.setColor(color76);
        color76.setVal("365F91");
        color76.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color76.setThemeShade("BF");
        // Create object for r
        R r40 = wmlObjectFactory.createR();
        p39.getContent().add(r40);
        // Create object for t (wrapped in JAXBElement)
        ...
        text40.setValue("tructural slab ");
        ...
        rpr40.setRFonts(rfonts77);
        rfonts77.setAscii("Arial");
        rfonts77.setHAnsi("Arial");
        rfonts77.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue91 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr40.setBCs(booleandefaulttrue91);
        // Create object for color
        Color color77 = wmlObjectFactory.createColor();
        rpr40.setColor(color77);
        color77.setVal("365F91");
        color77.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color77.setThemeShade("BF");
        // Create object for r
        R r41 = wmlObjectFactory.createR();
        p39.getContent().add(r41);
        // Create object for t (wrapped in JAXBElement)
        ...
        text41.setValue("stripping appeared to be in progress at the North, East and West areas of the project.");
        // Create object for rPr
        RPr rpr41 = wmlObjectFactory.createRPr();
        r41.setRPr(rpr41);
        // Create object for rFonts
        RFonts rfonts78 = wmlObjectFactory.createRFonts();
        rpr41.setRFonts(rfonts78);
        rfonts78.setAscii("Arial");
        rfonts78.setHAnsi("Arial");
        rfonts78.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue92 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr41.setBCs(booleandefaulttrue92);
        // Create object for color
        Color color78 = wmlObjectFactory.createColor();
        rpr41.setColor(color78);
        color78.setVal("365F91");
        color78.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color78.setThemeShade("BF");
        // Create object for pPr
        ...
        rfonts79.setAscii("Arial");
        rfonts79.setHAnsi("Arial");
        rfonts79.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue93 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr39.setBCs(booleandefaulttrue93);
        // Create object for color
        Color color79 = wmlObjectFactory.createColor();
        pararpr39.setColor(color79);
        color79.setVal("365F91");
        color79.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color79.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle18 = wmlObjectFactory.createPPrBasePStyle();
        ppr39.setPStyle(pprbasepstyle18);
        pprbasepstyle18.setVal("ListParagraph");
        // Create object for numPr
        PPrBase.NumPr pprbasenumpr7 = wmlObjectFactory.createPPrBaseNumPr();
        ppr39.setNumPr(pprbasenumpr7);
        // Create object for ilvl
        ...
        pprbasenumprnumid7.setVal(BigInteger.valueOf(43));
        // Create object for p
        P p40 = wmlObjectFactory.createP();
        tc4.getContent().add(p40);
        // Create object for pPr
        ...
        pararpr40.setRFonts(rfonts80);
        rfonts80.setAscii("Arial");
        rfonts80.setHAnsi("Arial");
        rfonts80.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue94 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr40.setBCs(booleandefaulttrue94);
        // Create object for color
        Color color80 = wmlObjectFactory.createColor();
        pararpr40.setColor(color80);
        color80.setVal("365F91");
        color80.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color80.setThemeShade("BF");
        // Create object for p
        P p41 = wmlObjectFactory.createP();
        tc4.getContent().add(p41);
        // Create object for r
        R r42 = wmlObjectFactory.createR();
        p41.getContent().add(r42);
        // Create object for t (wrapped in JAXBElement)
        ...
        text42.setValue("L10 Level roof forming walls appears to be in progress at the time of our visits.");
        // Create object for rPr
        RPr rpr42 = wmlObjectFactory.createRPr();
        r42.setRPr(rpr42);
        // Create object for rFonts
        RFonts rfonts81 = wmlObjectFactory.createRFonts();
        rpr42.setRFonts(rfonts81);
        rfonts81.setAscii("Arial");
        rfonts81.setHAnsi("Arial");
        rfonts81.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue95 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr42.setBCs(booleandefaulttrue95);
        // Create object for color
        Color color81 = wmlObjectFactory.createColor();
        rpr42.setColor(color81);
        color81.setVal("365F91");
        color81.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color81.setThemeShade("BF");
        // Create object for pPr
        ...
        pararpr41.setRFonts(rfonts82);
        rfonts82.setAscii("Arial");
        rfonts82.setHAnsi("Arial");
        rfonts82.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue96 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr41.setBCs(booleandefaulttrue96);
        // Create object for color
        Color color82 = wmlObjectFactory.createColor();
        pararpr41.setColor(color82);
        color82.setVal("365F91");
        color82.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color82.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle19 = wmlObjectFactory.createPPrBasePStyle();
        ppr41.setPStyle(pprbasepstyle19);
        pprbasepstyle19.setVal("ListParagraph");
        // Create object for numPr
        PPrBase.NumPr pprbasenumpr8 = wmlObjectFactory.createPPrBaseNumPr();
        ppr41.setNumPr(pprbasenumpr8);
        // Create object for ilvl
        PPrBase.NumPr.Ilvl pprbasenumprilvl8 = wmlObjectFactory.createPPrBaseNumPrIlvl();
        pprbasenumpr8.setIlvl(pprbasenumprilvl8);
        pprbasenumprilvl8.setVal(BigInteger.valueOf(0));
        // Create object for numId
        PPrBase.NumPr.NumId pprbasenumprnumid8 = wmlObjectFactory.createPPrBaseNumPrNumId();
        pprbasenumpr8.setNumId(pprbasenumprnumid8);
        pprbasenumprnumid8.setVal(BigInteger.valueOf(43));
        // Create object for p
        ...
        pararpr42.setRFonts(rfonts83);
        rfonts83.setAscii("Arial");
        rfonts83.setHAnsi("Arial");
        rfonts83.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue97 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr42.setBCs(booleandefaulttrue97);
        // Create object for color
        Color color83 = wmlObjectFactory.createColor();
        pararpr42.setColor(color83);
        color83.setVal("365F91");
        color83.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color83.setThemeShade("BF");
        // Create object for p
        P p43 = wmlObjectFactory.createP();
        tc4.getContent().add(p43);
        // Create object for r
        R r43 = wmlObjectFactory.createR();
        p43.getContent().add(r43);
        // Create object for t (wrapped in JAXBElement)
        ...
        text43.setValue("L10 Structural slab appears to be constructed.");
        // Create object for rPr
        RPr rpr43 = wmlObjectFactory.createRPr();
        r43.setRPr(rpr43);
        // Create object for rFonts
        RFonts rfonts84 = wmlObjectFactory.createRFonts();
        rpr43.setRFonts(rfonts84);
        rfonts84.setAscii("Arial");
        rfonts84.setHAnsi("Arial");
        rfonts84.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue98 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr43.setBCs(booleandefaulttrue98);
        // Create object for color
        Color color84 = wmlObjectFactory.createColor();
        rpr43.setColor(color84);
        color84.setVal("365F91");
        color84.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color84.setThemeShade("BF");
        // Create object for pPr
        ...
        pararpr43.setRFonts(rfonts85);
        rfonts85.setAscii("Arial");
        rfonts85.setHAnsi("Arial");
        rfonts85.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue99 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr43.setBCs(booleandefaulttrue99);
        // Create object for color
        Color color85 = wmlObjectFactory.createColor();
        pararpr43.setColor(color85);
        color85.setVal("365F91");
        color85.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color85.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle20 = wmlObjectFactory.createPPrBasePStyle();
        ppr43.setPStyle(pprbasepstyle20);
        pprbasepstyle20.setVal("ListParagraph");
        // Create object for numPr
        PPrBase.NumPr pprbasenumpr9 = wmlObjectFactory.createPPrBaseNumPr();
        ppr43.setNumPr(pprbasenumpr9);
        // Create object for ilvl
        PPrBase.NumPr.Ilvl pprbasenumprilvl9 = wmlObjectFactory.createPPrBaseNumPrIlvl();
        pprbasenumpr9.setIlvl(pprbasenumprilvl9);
        pprbasenumprilvl9.setVal(BigInteger.valueOf(0));
        // Create object for numId
        PPrBase.NumPr.NumId pprbasenumprnumid9 = wmlObjectFactory.createPPrBaseNumPrNumId();
        pprbasenumpr9.setNumId(pprbasenumprnumid9);
        pprbasenumprnumid9.setVal(BigInteger.valueOf(43));
        // Create object for p
        P p44 = wmlObjectFactory.createP();
        tc4.getContent().add(p44);
        // Create object for pPr
        ...
        pararpr44.setRFonts(rfonts86);
        rfonts86.setAscii("Arial");
        rfonts86.setHAnsi("Arial");
        rfonts86.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue100 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr44.setBCs(booleandefaulttrue100);
        // Create object for color
        Color color86 = wmlObjectFactory.createColor();
        pararpr44.setColor(color86);
        color86.setVal("365F91");
        color86.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color86.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle21 = wmlObjectFactory.createPPrBasePStyle();
        ppr44.setPStyle(pprbasepstyle21);
        pprbasepstyle21.setVal("ListParagraph");
        // Create object for p
        P p45 = wmlObjectFactory.createP();
        tc4.getContent().add(p45);
        // Create object for r
        R r44 = wmlObjectFactory.createR();
        p45.getContent().add(r44);
        // Create object for t (wrapped in JAXBElement)
        ...
        text44.setValue("L11 (Upper roof) slab appears to be constructed.");
        // Create object for rPr
        RPr rpr44 = wmlObjectFactory.createRPr();
        r44.setRPr(rpr44);
        // Create object for rFonts
        RFonts rfonts87 = wmlObjectFactory.createRFonts();
        rpr44.setRFonts(rfonts87);
        rfonts87.setAscii("Arial");
        rfonts87.setHAnsi("Arial");
        rfonts87.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue101 = wmlObjectFactory.createBooleanDefaultTrue();
        rpr44.setBCs(booleandefaulttrue101);
        // Create object for color
        Color color87 = wmlObjectFactory.createColor();
        rpr44.setColor(color87);
        color87.setVal("365F91");
        color87.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color87.setThemeShade("BF");
        // Create object for pPr
        ...
        pararpr45.setRFonts(rfonts88);
        rfonts88.setAscii("Arial");
        rfonts88.setHAnsi("Arial");
        rfonts88.setCs("Arial");
        // Create object for bCs
        BooleanDefaultTrue booleandefaulttrue102 = wmlObjectFactory.createBooleanDefaultTrue();
        pararpr45.setBCs(booleandefaulttrue102);
        // Create object for color
        Color color88 = wmlObjectFactory.createColor();
        pararpr45.setColor(color88);
        color88.setVal("365F91");
        color88.setThemeColor(org.docx4j.wml.STThemeColor.ACCENT_1);
        color88.setThemeShade("BF");
        // Create object for pStyle
        PPrBase.PStyle pprbasepstyle22 = wmlObjectFactory.createPPrBasePStyle();
        ppr45.setPStyle(pprbasepstyle22);
        pprbasepstyle22.setVal("ListParagraph");
        // Create object for numPr
        PPrBase.NumPr pprbasenumpr10 = wmlObjectFactory.createPPrBaseNumPr();
        ppr45.setNumPr(pprbasenumpr10);
        // Create object for ilvl
        PPrBase.NumPr.Ilvl pprbasenumprilvl10 = wmlObjectFactory.createPPrBaseNumPrIlvl();
        pprbasenumpr10.setIlvl(pprbasenumprilvl10);
        pprbasenumprilvl10.setVal(BigInteger.valueOf(0));
        // Create object for numId
